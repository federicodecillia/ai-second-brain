...
<!-- TODO(Federico): add a screenshot or GIF of the vault + an agent updating a note -->
...
## Customize / go pro
Adapt areas and templates to your field: `docs/customization.md`. Want CRM workflows, custom skills, and a done-for-you setup? [Get in touch](#).
